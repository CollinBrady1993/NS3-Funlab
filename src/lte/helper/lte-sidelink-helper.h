...
public:
   ...
   */
  void StartDiscoveryApps (Ptr<NetDevice> ueDevice, std::list<LteSlUeRrc::DiscPayload> appCodes, LteSlUeRrc::DiscoveryRole role);
   ...
   * \param role UE role (discovered or discoveree)
   */
  void StopDiscoveryApps (Ptr<NetDevice> ueDevice, std::list<LteSlUeRrc::DiscPayload> appCodes, LteSlUeRrc::DiscoveryRole role);

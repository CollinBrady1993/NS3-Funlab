...
void
LteSidelinkHelper::StartDiscoveryApps (Ptr<NetDevice> ueDevice, std::list<LteSlUeRrc::DiscPayload> appCodes, LteSlUeRrc::DiscoveryRole role)
{
  NS_LOG_FUNCTION (this);
...
void
LteSidelinkHelper::StopDiscoveryApps (Ptr<NetDevice> ueDevice, std::list<LteSlUeRrc::DiscPayload> appCodes, LteSlUeRrc::DiscoveryRole role)
{
  NS_LOG_FUNCTION (this);
